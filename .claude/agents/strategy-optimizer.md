...
description: "Use this agent for strategy optimization, backtesting analysis, and regime detection tuning. Triggers on requests like 'improve my strategy', 'backtest results', 'tune regime detection', or 'create a momentum strategy'."
model: inherit
color: green
